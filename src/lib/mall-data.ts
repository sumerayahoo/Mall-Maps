...
export const PRODUCTS: Product[] = [
  { id: "p1", name: "Quilted Chain Shoulder Bag", color: "pink", category: "bag", price: 11750, storeId: "g-bagbar", tags: ["handbag", "chain", "quilted", "evening"] },
  { id: "p2", name: "Blush Leather Tote", color: "pink", category: "bag", price: 9950, storeId: "g-charles", tags: ["tote", "leather", "work"] },
  { id: "p3", name: "Rose Mini Crossbody", color: "pink", category: "bag", price: 8400, storeId: "f1-aldo", tags: ["crossbody", "mini", "party"] },
  { id: "p4", name: "Fuchsia Party Clutch", color: "pink", category: "bag", price: 7200, storeId: "f1-lc", tags: ["clutch", "party", "satin"] },
  { id: "p5", name: "Pink Canvas Backpack", color: "pink", category: "bag", price: 5500, storeId: "f1-adidas", tags: ["backpack", "sports", "canvas"] },
  { id: "p6", name: "Pastel Pink Shopper", color: "pink", category: "bag", price: 4550, storeId: "g-hm", tags: ["shopper", "tote", "casual"] },
  { id: "p7", name: "Bubblegum Kids Bag", color: "pink", category: "bag", price: 2150, storeId: "f1-kidsworld", tags: ["kids", "cute", "school"] },
  { id: "p8", name: "Structured Black Tote", color: "black", category: "bag", price: 12500, storeId: "g-zara", tags: ["tote", "office", "leather"] },
  { id: "p9", name: "Tan Saddle Bag", color: "brown", category: "bag", price: 9000, storeId: "g-charles", tags: ["saddle", "leather"] },
  { id: "p10", name: "Beige Hobo Bag", color: "beige", category: "bag", price: 6350, storeId: "f1-mango", tags: ["hobo", "slouchy"] },
  { id: "p11", name: "Pink Running Sneakers", color: "pink", category: "shoes", price: 7450, storeId: "g-nike", tags: ["sneakers", "running"] },
  { id: "p12", name: "Rose Gold Heels", color: "pink", category: "shoes", price: 6600, storeId: "f1-aldo", tags: ["heels", "party"] },
  { id: "p13", name: "Pink Hiking Daypack", color: "pink", category: "bag", price: 3800, storeId: "f1-decathlon", tags: ["backpack", "outdoor", "hiking"] },
  { id: "p14", name: "Pink Silk Scarf", color: "pink", category: "accessory", price: 2900, storeId: "g-zara", tags: ["scarf", "silk"] },
  { id: "p15", name: "Blue Denim Jacket", color: "blue", category: "clothing", price: 5050, storeId: "f1-uniqlo", tags: ["denim", "jacket"] },
  { id: "p16", name: "White Sneakers", color: "white", category: "shoes", price: 5750, storeId: "g-nike", tags: ["sneakers", "casual"] },
  { id: "p17", name: "Pink Smartwatch Band", color: "pink", category: "accessory", price: 2300, storeId: "g-apple", tags: ["watch", "band", "tech"] },
  { id: "p18", name: "Coral Beach Bag", color: "pink", category: "bag", price: 3500, storeId: "g-hm", tags: ["beach", "straw", "summer"] },
];